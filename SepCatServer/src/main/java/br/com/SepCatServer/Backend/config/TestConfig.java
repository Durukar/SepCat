...
public class TestConfig implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        Inssue i1 = new Inssue (null, Instant.parse("2019-06-20T19:53:07Z"), u1);
        Inssue i2 = new Inssue (null, Instant.parse("2019-07-21T03:42:10Z"), u2);
        Inssue i3 = new Inssue (null, Instant.parse("2019-07-22T15:21:22Z"), u1);
